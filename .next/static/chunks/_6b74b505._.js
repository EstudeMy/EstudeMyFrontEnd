...
"[project]/src/app/contexts/ThemeContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ThemeProvider(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeProvider.useEffect": ()=>{
            const loadTheme = {
                "ThemeProvider.useEffect.loadTheme": async ()=>{
                    const token = localStorage.getItem("token");
    ...
    const setTheme = async function(newTheme) {
        let saveToBackend = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
        ...
        if (saveToBackend && !isPublicRoute) {
            ...
            if (token) {
                try {
                    const API_URL = ("TURBOPACK compile-time value", "https://estude-my.onrender.com/") || "http://localhost:5000";
                    const response = await fetch("".concat(API_URL, "/api/users/tema"), {
                        method: "PUT",
                        headers: {
...
_s(ThemeProvider, "ruaXMX9aC23B3tTe1o1MoyjbcsA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
...
//# sourceMappingURL=_6b74b505._.js.map