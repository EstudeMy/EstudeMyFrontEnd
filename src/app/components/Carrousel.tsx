    ...
    >
      <div className="flex items-center gap-2 w-full">
        <button
          ...
          className={`flex-shrink-0 hover:bg-[var(--bg-input)] rounded transition-colors duration-300 z-10 ${
        ...
        >
          {items.map((item) => (
            <div
              ...
              className="flex-shrink-0 w-full rounded-lg border bg-[var(--bg-card)] shadow hover:shadow-xl hover:scale-105 cursor-pointer transition-all duration-200 transform border-[var(--border-color)]"
