...
export default function LandingPage() {
    ...
    return (
        ...
        <main
            ...
            style={{backgroundImage: `url('${backgroundImage}')`}} // Imagem de fundo
        >
                ...
                <section className="text-center max-w-3xl mb-12">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mt-10">
                        <motion.a
                            ...
                            className="bg-[#2b9348] text-black px-8 py-4 border-4 border-[#1b1b1b] shadow-[8px_8px_0_0_#000000] rounded-xl font-extrabold text-1xl transition-transform"
                        >
                            Começar agora!
                        </motion.a>
