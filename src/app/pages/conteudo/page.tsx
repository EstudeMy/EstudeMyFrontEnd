  ...
  if (loading) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        <div className="text-lg text-[var(--text-secondary)]">Carregando conteúdo...</div>
      </main>
    );
  }
    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <section className="w-full max-w-3xl bg-white p-8 rounded-xl shadow-lg border border-gray-200 mx-4">
        <div className="mb-6">
          ...
          {fase.descricao && (
            <p className="text-sm text-[var(--text-secondary)] mb-4">{fase.descricao}</p>
          )}
        </div>

        {/* Conteúdo da aula */}
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">Aula</h2>
          <div
