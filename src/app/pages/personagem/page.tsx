...
export default function PersonagemPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--bg-page)] transition-colors duration-300" style={{ backgroundColor: 'var(--bg-page)' }}>
        <p className="text-lg text-[var(--text-secondary)]">Carregando...</p>
      </div>
    );
  }
  ...
  if (!userData) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--bg-page)] transition-colors duration-300" style={{ backgroundColor: 'var(--bg-page)' }}>
        <p className="text-lg text-red-600 dark:text-red-400">Erro ao carregar dados do usuário.</p>
      </div>
    );
  }
    ...
    >
      <div className="relative z-0">
        <div className="flex flex-col min-h-screen">
          ...
          {/* Container principal */}
          <div className="flex-1 flex items-start justify-center px-4 sm:px-6 md:px-8 lg:px-20 py-4 sm:py-6 w-full">
            <div className="w-full max-w-4xl mx-auto">
              <div className="bg-[var(--bg-card)] rounded-lg shadow-md p-4 sm:p-6 md:p-8 border border-[var(--border-color)] transition-colors duration-300" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
                <h1 className="text-2xl md:text-3xl font-bold mb-6 text-center text-[var(--text-primary)]">
                ...
                {/* Seleção de Classe */}
                <div className="mb-8">
                  <h2 className="text-xl font-semibold mb-4 text-[var(--text-primary)]">Escolha sua Classe</h2>
                    ...
                    {CLASSES.map((classe) => (
                      <div
                        ...
                        onClick={() => {
                          ...
                          setSkinSelecionada("Padrão"); // Resetar skin ao mudar classe
                        }}
                        className={`cursor-pointer rounded-xl border-4 transition-all transform hover:scale-105 ${
